# AGENTS.md — ProBuild Project Context
...
- **Full context, minimum tokens** — read the 4 reference docs (AGENTS.md, VISION.md, DESIGN_SYSTEM.md, ProbuildTodo.md) for context, then build. Don't explore the codebase unless you're editing a file you haven't seen.
