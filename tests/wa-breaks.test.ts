...
test("settleDayPlan: single 8h entry, took lunch → AUTO_DEDUCTED 0.5 on it, paid 7.5, no flag", () => {
    ...
    assert.deepEqual(plan, [{ id: "a", shiftHours: 8, mealDeductionHours: 0.5, paidHours: 7.5, mealOutcome: "AUTO_DEDUCTED", reviewReason: MEAL_CONFIRMED_NOTE, needsReview: false }]);
});
