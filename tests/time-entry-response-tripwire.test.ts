...
const MANIFEST: Record<string, { kind: "serializer" | "select" | "no-entry"; via: string; why: string }> = {
    ...
    "app/api/time-entries/route.ts:148": {
        kind: "serializer", via: "serializeTimeEntryJson",
    ...
    "app/api/time-entries/route.ts:915": {
        kind: "no-entry",
        via: "error.message",
