...
const MANIFEST: Record<string, { kind: "guarded" | "exempt"; why: string }> = {
    ...
    "app/api/time-entries/route.ts:1084::update": {
        kind: "guarded",
    ...
    // ---- server actions -----------------------------------------------------
    "lib/actions.ts:3638::updateMany": {
        kind: "exempt",
    ...
    "lib/actions.ts:15346::updateMany": {
        kind: "guarded",
