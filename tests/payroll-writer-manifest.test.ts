...
const MANIFEST: Record<string, { kind: "guarded" | "exempt"; why: string }> = {
    ...
    // ---- server actions -----------------------------------------------------
    "lib/actions.ts:3718::updateMany": {
        kind: "exempt",
    ...
    "lib/actions.ts:15845::updateMany": {
        kind: "guarded",
    ...
    // ---- billing ------------------------------------------------------------
    "lib/billing-core.ts:1787::updateMany": {
        kind: "exempt",
