...
const retained: Record<string, string> = {
    "lib/actions.ts:3254": "estimate-item deletion retains historical source evidence",
    "lib/actions.ts:5470": "estimate deletion retains historical source evidence",
    "lib/payroll-parent-delete.ts:96": "parent deletion refuses any retained source row",
    "lib/actions.ts:3648": "structural deletion must see retained historical evidence",
