...
const retained: Record<string, string> = {
    "lib/actions.ts:3272": "estimate-item deletion retains historical source evidence",
    "lib/actions.ts:5488": "estimate deletion retains historical source evidence",
    "lib/payroll-parent-delete.ts:96": "parent deletion refuses any retained source row",
    "lib/actions.ts:3666": "structural deletion must see retained historical evidence",
