...
const MANIFEST: Record<string, { kind: "wrapped" | "guarded" | "exempt"; why: string }> = {
    ...
    "app/api/manager/employees/[id]/route.ts:101::update": {
        kind: "wrapped",
