...
type Estimate = {
    ...
    lead?: { id: string; name: string; client?: { name: string } | null } | null;
};

export default function EstimatesPageClient({ estimates }: { estimates: Estimate[] }) {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-64px)] bg-hui-background -m-6">
            <div className="bg-white border-b border-hui-border">
                ...
                <div className="flex px-6 border-t border-hui-border">
                    <TabButton active={activeTab === "estimates"} onClick={() => setActiveTab("estimates")}>
                        Estimates
                    </TabButton>
            ...
            {activeTab === "estimates" ? (
                ...
                <div className="flex-1 overflow-hidden">
                    <DocumentTemplateManager
                        ...
                        description="Manage T&C language for your estimates"
                    />
                </div>
            )}
        </div>
