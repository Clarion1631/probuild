                                            ...
                                            {showEstimateLinkMenu && (() => {
                                                ...
                                                const renderItem = (item: EstimateItemSummary, keyPrefix = "") => (
                                                    <button
                                                        ...
                                                        className="w-full text-left px-3 py-2.5 hover:bg-slate-50 transition text-xs"
                                                    >
                                                        <div className="font-medium truncate">{item.name}</div>
                                                        <div className="text-slate-400 mt-0.5">{item.type} · {formatCurrency(item.total)}</div>
                                                    </button>
                                                );
