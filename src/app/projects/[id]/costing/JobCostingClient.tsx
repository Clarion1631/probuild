...
// ⚡ Bolt: Dynamically import heavy Recharts component to prevent blocking the main thread during hydration
// Impact: Reduces First Input Delay and initial JS bundle size on the costing dashboard
const JobCostingChart = dynamic(() => import("./JobCostingChart"), {
    ssr: false,
    loading: () => <div className="animate-pulse rounded-md bg-slate-200 w-full h-[280px]"></div>
});
        ...
        <div className="w-full max-w-6xl mx-auto pb-20">
            ...
            {sortedSummaries.length > 0 && (
                <div className="bg-white rounded-xl shadow-sm border border-hui-border p-5 mb-6">
                    ...
                    <JobCostingChart sortedSummaries={sortedSummaries} />
                </div>
            )}
