...
// won, so it starts life "In Progress" and only ever moves forward:
//   1. In Progress → 2. Substantial Completion → 3. Closed Complete / 4. Closed Lost
...
export const OPEN_PROJECT_STATUSES = ["In Progress", "Substantial Completion"];
...
export const LEGACY_PROJECT_STATUS_MAP: Record<string, string> = {
    "Open": "In Progress",
    "Active": "In Progress",
    "Paid Ready to Start": "In Progress",
    "Paid, Ready to Start": "In Progress",
