    ...
    return (
        <aside className="w-20 bg-hui-sidebar text-white flex flex-col min-h-screen items-center py-4 relative z-50">
            ...
            <nav className="flex-1 w-full space-y-2 flex flex-col items-center">
                ...
                <Link href="/settings/team" className="flex flex-col items-center justify-center w-full py-3 hover:bg-[#2a2a2a] text-slate-400 hover:text-white transition group">
