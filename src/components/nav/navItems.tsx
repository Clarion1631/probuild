...
export const NAV_ITEMS: NavItem[] = [
  ...
  // Field + Time Clock retired from the web nav 2026-07-31 (the mobile app is
  // the time clock; time entries are entered per project). Their routes still
  // exist — only the nav entries were removed.
  { key: "automation", href: "/automation", label: "Automation", Icon: AutomationIcon, show: (can) => can("financialReports") },
